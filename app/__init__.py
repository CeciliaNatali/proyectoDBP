...
app.register_blueprint(indice_bp, url_prefix='/cuenta')
app.register_blueprint(ingreso_bp, url_prefix='/cuenta')
app.register_blueprint(cuenta_bp, url_prefix='/cuenta')
app.register_blueprint(playlist_bp, url_prefix='/cuenta')
app.register_blueprint(fondo_bp, url_prefix='/cuenta')
